...
export const NotifyEmail = () => {
            ...
            <div className="min-w-full divide-y divide-gray-300">
              ...
              <div className="ml-4 grid grid-cols-1 divide-y">
                <div className="text-left text-slate-700 dark:text-slate-50 text-sm">
                  ...
                  <span>{notifyemail.notifyemail} </span>
                </div>
                  ...
                  <div className="w-0 flex-1 flex">
                    ...
                    >
                      <img
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3 dark:text-sky-100 text-slate-700">Email</span>
                    </a>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="mt-20 bg-white dark:bg-slate-800 w-full divide-y divide-gray-300">
      <div className="mt-1">
